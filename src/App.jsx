          ...
          <>
            ...
            {reflection && (
              <div className="reflection-block">
                ...
                {!showReflection ? (
                  <button className="reflection-toggle" onClick={onOpenReflection}>
                  ...
                  <div className="reflection-panel">
                    ...
                    <p className="reflection-disclaimer">
                      This reflection is generated by AI for personal prayer
                      and reflection. It is not official Church teaching, a
                      homily, or a substitute for one.
                    </p>
