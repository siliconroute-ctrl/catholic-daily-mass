 ...
 *   .social-video-<date>.mp4 in the project root.
 *
 * NOTE: this file is also imported by post-to-facebook.js and
 * post-to-youtube.js purely to reuse the socialVideoPath() helper, so the
 * actual build logic below is guarded to only run when this file is
 * executed directly — never as a side effect of importing it.
 */
